...
public class HomeJpAdapter extends RecyclerView.Adapter<HomeJpAdapter.HomeJpViewHodler> {
    private Context context;
    private List<HomeJp.DataBean.ResourceJpBean> list;

    public HomeJpAdapter(Context context, List<HomeJp.DataBean.ResourceJpBean> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public HomeJpViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_home_first, parent, false);
        return new HomeJpViewHodler(view);
    }
